...
We can check whether there is any repeated recording for `occurrenceID` as it is a unique identifier for each record.
...
```{r}
# We already have the plot_1 from the previous code
...
plot_3 <- ggplot(data_sorted, aes(x = Date_Object)) +
  ...
  scale_color_manual(values = c("Observed Data" = "#1f77b4", "Logistic Fit" = "#d62728"))

# Add horizontal lines for the estimates and best-guess number
plot_3 <- plot_3 +
  geom_hline(yintercept = 196, color = "brown", linetype = "dashed", linewidth = 1) +
  geom_hline(yintercept = 202, color = "green", linetype = "dashed", linewidth = 1) +
  geom_hline(yintercept = 246, color = "blue", linetype = "dashed", linewidth = 1) +
  geom_text(aes(x = min(data_sorted$Date_Object), y = 196, label = "Extrapolation: 196"), 
            hjust = -0.1, vjust = 1.5, color = "brown", size = 3) +
  geom_text(aes(x = min(data_sorted$Date_Object), y = 202, label = "Chao1: 202"), 
            hjust = -0.1, vjust = -0.5, color = "green", size = 3) +
  geom_text(aes(x = min(data_sorted$Date_Object), y = 246, label = "Best-Guess: 246"), 
            hjust = -0.1, vjust = 1.5, color = "blue", size = 3)
