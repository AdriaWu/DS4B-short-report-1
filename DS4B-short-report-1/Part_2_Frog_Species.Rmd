...
# Sort the data by date (written by ChatGPT)
data_sorted <- data_2 |>
  arrange(Date_Object) |>
...
# For 95% confidence intervals, we use the variance formula for Chao1 (written by ChatGPT):
...
```{r}
# We already have the plot 1 from the previous code
