...
# Extract the estimated K (carrying capacity) which represents the total number of species.
...
- N0 (initial species count) = 81.10501
...
plot_2 <- ggplot(data_sorted, aes(x = Date_Object)) +
