...
plot_1_2 <- plot_1 +
  geom_hline(yintercept = 196, color = "red", linetype = "dashed", linewidth = 0.5) +
  geom_hline(yintercept = 202, color = "green", linetype = "dashed", linewidth = 0.5) +
  geom_hline(yintercept = 246, color = "blue", linetype = "dashed", linewidth = 0.5) +
